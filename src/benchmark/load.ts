...
const schema = z.array(z.object({case_id:z.string(),ground_truth:z.enum(["solvable_without_missing","requires_missing"]),user_task:z.string(),expected_tool:z.string().optional(),case_family:z.string(),difficulty:z.enum(["easy","medium","hard"]).optional()}));
