...
export function deriveExperiment5b13PlannerSource(source:string){let x=deriveExperiment5b12PlannerSource(source);
 ...
 x=x.replaceAll('requestOrderingDeterminism5B3(c,localized.hypotheses,localized.evidence,utilityProofById,historicalPrimary)','requestOrderingDeterminism5B13(c,localized.hypotheses,localized.evidence,utilityProofById,documentaryWitnessById,historicalPrimary)');
 x=x.replaceAll('rankRequestBeam5B3(c,localized.hypotheses,localized.evidence,utilityProofById,historicalPrimary)','rankRequestBeam5B13(c,localized.hypotheses,localized.evidence,utilityProofById,documentaryWitnessById,historicalPrimary)');
