...
import {deriveExperiment5b17Source} from "./experiment5b17Derivation.js";
...
const generated=deriveExperiment5b17Source(source).replace("async function rerank(async function rerank(","async function rerank(");
await writeFile(new URL("./.generated-experiment5b17.ts",import.meta.url),generated);
const generatedImport="./.generated-experiment5b17.js";
