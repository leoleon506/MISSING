...
describe("Experiment 5B14 generated benchmark integrity",()=>{
 ...
 it("persists documentary witness and 5B14 utility from planner output before contract normalization",()=>{const src=readFileSync("src/experiment4ar.ts","utf8"),generated=deriveExperiment5b14Source(src);expect(generated).toContain("planner_output:planner||null");expect(generated).toContain("planner_output?.documentary_witness_5b12");expect(generated).toContain("planner_output?.request_utility_5b14");expect(generated).toContain("documentary_witness_5b12:");expect(generated).toContain("request_utility_5b14:");});
});
